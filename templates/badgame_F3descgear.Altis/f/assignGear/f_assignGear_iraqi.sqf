...
// Backpacks
_bagsmall = "LOP_FieldPack_CBR";			// carries 120, weighs 20
...
_baseUniform = ["Niko_USA_6cd","Niko_USA_R_6cd"];
_baseHelmet = ["Niko_MICH_Tan","rhsusf_ach_bare_tan"];
_baseGlasses = nil;
...
//	_loadout = f_param_backpacks;
	...
	{
		#include "f_assignGear_iraqi_b.sqf";
	};
};
