...
_scope1 = "BWA3_optic_ZO4x30";	// Holosight
_scope2 = "BWA3_optic_ZO4x30";			// MRCO Scope - 1x - 6x
_scope4 = "BWA3_optic_ZO4x30";
_scope3 = "BWA3_optic_20x50";			// SOS Scope - 18x - 75x

_bipod2 = "bipod_01_F_snd";		// Default bipod
_bipod1 = "bipod_02_F_blk";		// Black bipod
...
// ATTACHMENTS - HANDGUN
_hg_silencer1 = "RH_m9qd";	// .45 suppressor
...
// Backpacks
_bagsmall = "BWA3_AssaultPack_Fleck";			// carries 120, weighs 20
_bagmedium = "BWA3_Kitbag_Fleck";				// carries 240, weighs 30
...
// Marksman rifle
_DMrifle = "BWA3_G28_Standard";
_DMriflemag = "BWA3_10Rnd_762x51_G28";
...
// Sniper
_SNrifle = "hlc_rifle_awmagnum";
_SNrifleMag = "hlc_5rnd_300WM_FMJ_AWM";
...
// Vests
_lightRig = ["BWA3_Vest_Leader_Fleck"];
_mediumRig = ["BWA3_Vest_Rifleman1_Fleck"]; 	// default for all infantry classes
_heavyRig = ["BWA3_Vest_Autorifleman_Fleck"];
...
//	_loadout = f_param_backpacks;
	...
	{
		#include "f_assignGear_bundeswehr_f_b.sqf";
	};
};
