...
// Automatic Rifleman
_AR = "rhs_weap_m240B_CAP";
_ARmag = "rhsusf_100Rnd_762x51";
_ARmag_tr = "rhsusf_100Rnd_762x51";
...
// Marksman rifle
_DMrifle = "hlc_rifle_c1A1";
_DMriflemag = "hlc_20Rnd_762x51_B_fal";
...
_baseHelmet = ["IAF_UN_Helmet"];
_baseGlasses = nil;

// Vests
_lightRig = ["rhs_6b23_6sh92_vog"];
...
//	_loadout = f_param_backpacks;
	...
	{
		#include "f_assignGear_uno_b.sqf";
	};
};
