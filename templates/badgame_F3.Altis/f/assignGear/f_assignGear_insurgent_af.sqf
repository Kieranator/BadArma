...
_scope3 = "HLC_Optic_SMLEScope";			// SOS Scope - 18x - 75x
...
_rifle = ["hlc_rifle_ak74_dirty","hlc_rifle_ak74","hlc_rifle_akm","rhs_weap_akms","hlc_rifle_g3a3","hlc_rifle_FAL5061","FH_rifle_SKS","hlc_rifle_L1A1SLR"]; //hlc_rifle_L1A1SLR
_nr = floor(random(count(_rifle)));
_rifle = _rifle select _nr;
_riflemag = ["hlc_30Rnd_545x39_B_AK","hlc_30Rnd_545x39_B_AK","hlc_30Rnd_762x39_b_ak","rhs_30Rnd_762x39mm","hlc_20rnd_762x51_b_G3","hlc_20Rnd_762x51_B_fal","FH_SKS_10Rnd_762x39_Ball","hlc_20Rnd_762x51_B_fal"];
_riflemag = _riflemag select _nr;
_riflemag_tr = ["hlc_30Rnd_545x39_B_AK","hlc_30Rnd_545x39_B_AK","hlc_30Rnd_762x39_b_ak","rhs_30Rnd_762x39mm","hlc_20rnd_762x51_b_G3","hlc_20Rnd_762x51_B_fal","FH_SKS_10Rnd_762x39_Ball","hlc_20Rnd_762x51_B_fal"];
_riflemag_tr = _riflemag_tr select _nr;

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["hlc_rifle_aks74","hlc_rifle_ak74","hlc_rifle_akm","hlc_rifle_ak74_dirty","hlc_rifle_g3a3","hlc_rifle_FAL5061","FH_rifle_SKS","hlc_rifle_L1A1SLR"];
_nr = floor(random(count(_carbine)));
_carbine = _carbine select _nr;
_carbinemag = ["hlc_30Rnd_545x39_B_AK","hlc_30Rnd_545x39_B_AK","hlc_30Rnd_762x39_b_ak","hlc_30Rnd_762x39_b_ak","hlc_20rnd_762x51_b_G3","hlc_20Rnd_762x51_B_fal","FH_SKS_10Rnd_762x39_Ball","hlc_20Rnd_762x51_B_fal"];
_carbinemag = _carbinemag select _nr;
_carbinemag_tr = ["hlc_30Rnd_545x39_B_AK","hlc_30Rnd_545x39_B_AK","hlc_30Rnd_762x39_b_ak","hlc_30Rnd_762x39_b_ak","hlc_20rnd_762x51_b_G3","hlc_20Rnd_762x51_B_fal","FH_SKS_10Rnd_762x39_Ball","hlc_20Rnd_762x51_B_fal"];
...
_pistol = ["RH_m9","RH_m1911","RH_mak","RH_tt33"];
_nr = floor(random(count(_pistol)));
_pistol = _pistol select _nr;
_pistolmag = ["RH_15Rnd_9x19_M9","RH_7Rnd_45cal_m1911","RH_8Rnd_9x18_Mak","RH_8Rnd_762_tt33"];
_pistolmag = _pistolmag select _nr;
...
// Backpacks
_bagsmall = ["B_AssaultPack_rgr","B_AssaultPack_cbr","B_AssaultPack_sgg","B_Kitbag_rgr"];                               // carries 160, weighs 20
_nr = floor(random(count(_bagsmall)));
_bagsmall = _bagsmall select _nr;
_bagmedium = ["B_FieldPack_khk","B_Kitbag_rgr"];                                // carries 200, weighs 30
_nr = floor(random(count(_bagmedium)));
_bagmedium = _bagmedium select _nr;
_baglarge =  ["B_Carryall_oli","B_Carryall_khk","B_FieldPack_khk"];                             // carries 320, weighs 60
_nr = floor(random(count(_baglarge)));
_baglarge = _baglarge select _nr;
...
// Automatic Rifleman
_AR = ["rhs_weap_pkm","hlc_rifle_rpk"];
_nr = floor(random(count(_AR)));
_AR = _AR select _nr;
_ARmag = ["rhs_100Rnd_762x54mmR","hlc_45Rnd_762x39_m_rpk"];
_ARmag = _ARmag select _nr;
_ARmag_tr = ["rhs_100Rnd_762x54mmR_green","hlc_45Rnd_762x39_m_rpk"];
_ARmag_tr = _ARmag_tr select _nr;

// Medium MG
_MMG = ["rhs_weap_pkm","hlc_lmg_m60"];
_nr = floor(random(count(_MMG)));
_MMG = _MMG select _nr;
_MMGmag = ["rhs_100Rnd_762x54mmR","hlc_100Rnd_762x51_B_M60E4"];
_MMGmag = _MMGmag select _nr;
_MMGmag_tr = ["rhs_100Rnd_762x54mmR_green","hlc_100Rnd_762x51_B_M60E4"];
_MMGmag_tr = _MMGmag_tr select _nr;
...
_baseUniform = ["LOP_U_AFR_Fatigue_01","LOP_U_AFR_Fatigue_02","LOP_U_AFR_Fatigue_03","LOP_U_AFR_Fatigue_04","LOP_U_AFR_Fatigue_04_slv","LOP_U_Civ_01","LOP_U_Civ_02","LOP_U_Civ_03","LOP_U_Civ_04","LOP_U_Civ_05","LOP_U_Civ_06","LOP_U_Civ_01S","LOP_U_Civ_02S","LOP_U_Civ_03S","LOP_U_Civ_04S","LOP_U_Civ_05S","LOP_U_Civ_06S"];
_baseHelmet = ["H_Cap_tan", "H_Cap_blk", "H_Cap_blk_Raven", "H_Cap_blk_ION", "H_Bandanna_khk", "H_Bandanna_sgg", "H_Bandanna_cbr", "H_Bandanna_gry", "H_Bandanna_camo", "H_Bandanna_mcamo", 
			 "H_Bandanna_surfer", "","","","",
			 "H_StrawHat_dark", "H_Hat_blue", "H_Hat_brown", "H_Hat_camo", "H_Hat_grey", "H_Hat_checker", "H_Hat_tan"];

     
_lightRig = ["V_BandollierB_oli","V_HarnessO_blk","V_BandollierB_blk","V_BandollierB_khk","V_HarnessO_brn","LOP_V_Chestrig_vsr","LOP_V_Chestrig_vsr","p2_ak"];
_baseGlasses = [];
