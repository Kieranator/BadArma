// F3 - Folk ARPS Assign Gear Script - MEC
...
_glrifle = "HLC_Rifle_g3ka4_GL_MRCO";
...
// Marksman rifle
_DMrifle = "hlc_rifle_g3sg1_ACC";
_DMriflemag = "hlc_20rnd_762x51_b_G3";
...
// Woodland-Hex
_baseUniform = ["U_O_MecUniform"];
_baseHelmet = ["BG_PASGTHelmet_MEC1","BG_PASGTHelmet_MEC2"];
_baseGlasses = [];
...
_mediumRig = ["BG_PlateCarrierIA_Green"]; 	// default for all infantry classes
...
// Crewman
_crewUniform = ["U_O_MecUniform_Black"];
_crewHelmet = ["H_HelmetCrew_MEC"];
...
// Spec Op
_sfuniform = ["U_O_MecUniform_Black"];
...
//	_loadout = f_param_backpacks;
	...
	{
		#include "f_assignGear_mec_b.sqf";
	};
};
