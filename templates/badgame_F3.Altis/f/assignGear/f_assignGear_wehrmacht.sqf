...
_rifle = ["LIB_K98","LIB_G43"]; //hlc_rifle_L1A1SLR
_nr = floor(random(count(_rifle)));
_rifle = _rifle select _nr;
_riflemag = ["lib_5Rnd_792x57","lib_10Rnd_792x57"];
_riflemag = _riflemag select _nr;
_riflemag_tr = ["lib_5Rnd_792x57","lib_10Rnd_792x57"];
...
_glrifle = "LIB_MP44";
_glriflemag = "lib_30Rnd_792x33";
_glriflemag_tr = "lib_30Rnd_792x33";
_glmag = "lib_shg24";

// Smoke for FTLs, Squad Leaders, etc
_glsmokewhite = "lib_nb39";
_glsmokegreen = "lib_nb39";
_glsmokered = "lib_nb39";

// Flares for FTLs, Squad Leaders, etc
_glflarewhite = "lib_nb39";
_glflarered = "lib_nb39";
_glflareyellow = "lib_nb39";
_glflaregreen = "lib_nb39";
...
_bagmedium = "B_LIB_GER_SapperBackpack";				// carries 240, weighs 30
_baglarge =  "B_LIB_GER_SapperBackpack"; 			// carries 320, weighs 40
...
// Heavy AT
_HAT = "LIB_RPzB";
_HATmag1 = "LIB_1Rnd_RPzB";
_HATmag2 = "LIB_1Rnd_RPzB";
...
_baseUniform = ["U_LIB_GER_MG_schutze","U_LIB_GER_Gefreiter","U_LIB_GER_Oberschutze", "U_LIB_GER_MG_schutze"];
_baseHelmet = ["H_LIB_GER_Helmet","H_LIB_GER_HelmetCamo","H_LIB_GER_Cap"];
_baseGlasses = [];


// Vests
_lightRig = ["V_LIB_GER_VestKar98","V_LIB_GER_VestG43"];
_mediumRig = ["V_LIB_GER_VestMP40","V_LIB_GER_VestSTG"]; 	// default for all infantry classes
_heavyRig = ["V_LIB_GER_VestMG"];
...
// Ghillie
_ghillieUniform = ["U_LIB_GER_Scharfschutze"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_LIB_GER_HelmetCamo"];
_ghillieRig = ["V_LIB_GER_SniperBelt"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["U_LIB_GER_Leutnant"];
_sfhelmet = ["H_LIB_GER_OfficerCap"];
_sfRig = ["V_LIB_GER_VestMP40"];
_sfGlasses = [];
...
//	_loadout = f_param_backpacks;
	...
	{
		#include "f_assignGear_wehrmacht_b.sqf";
	};
};
