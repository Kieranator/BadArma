...
_silencer1 = "RH_qdss_nt4";	// 5.56 suppressor
_silencer2 = "RH_m110sd";	// 7.62 suppressor

_scope1 = "rhsusf_acc_eotech_552";		// Holosight
_scope2 = "rhsusf_acc_compm4";			// Reflex Sight
_scope3 = "RH_ta31rco";					// RCO
_scope4 = "RH_ta648";					// MG Optic
_scope5 = "rhsusf_acc_LEUPOLDMK4";		// Marksman Optic
_scope6 = "RH_leu_mk4";					// Sniper Optic

_bipod1 = "rhsusf_acc_harris_bipod";		// Default bipod
_bipod2 = "RH_HBLM_wdl";		// Black bipod
...
// ATTACHMENTS - HANDGUN
_hg_silencer1 = "RH_gemtech45";	// .45 suppressor

_hg_scope1 = "";			// MRD

// Default setup
_hg_attachments= ["RH_X300"]; // The default attachment set for handguns, overwritten in the individual unitType
...
_rifle = "RH_M4_ris_m";
_riflemag = "RH_30Rnd_556x45_Mk262";
_riflemag_tr = "RH_30Rnd_556x45_Mk262";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "RH_M4A1_ris";
_carbinemag = "RH_30Rnd_556x45_Mk262";
_carbinemag_tr = "RH_30Rnd_556x45_Mk262";
...
_glriflemag = "RH_30Rnd_556x45_Mk262";
_glriflemag_tr = "RH_30Rnd_556x45_Mk262";
...
_pistol = "RH_kimber_nw";
_pistolmag = "RH_7Rnd_45cal_m1911";
...
// Automatic Rifleman
_AR = "RH_M27IAR";
_ARmag = "RH_60Rnd_556x45_Mk262";
_ARmag_tr = "RH_60Rnd_556x45_Mk262";

// Medium MG
_MMG = "rhs_weap_m240B_CAP";
_MMGmag = "rhsusf_100Rnd_762x51_m80a1epr";
_MMGmag_tr = "rhsusf_100Rnd_762x51_m80a1epr";
...
// Sniper
_SNrifle = "RH_m110";
_SNrifleMag = "RH_20Rnd_762x51_Mk316LR";
...
_baseHelmet = ["rhsusf_ach_bare_des_headset","rhsusf_ach_bare_des_headset_ess"];
_baseGlasses = ["L_Shemagh_Gry","L_Shemagh_OD","L_Shemagh_Tan","LBG_Shemagh_Gry","LBG_Shemagh_OD","LBG_Shemagh_Tan","LCG_Shemagh_Gry","LCG_Shemagh_OD","LCG_Shemagh_Tan","LOG_Shemagh_Gry","LOG_Shemagh_OD","LOG_Shemagh_Tan"];

// Vests
_lightRig = ["Niko_USA_PlateCarrierL_CB"];
_mediumRig = ["Niko_USA_PlateCarrierH_CB"]; 	// default for all infantry classes
_heavyRig = ["Niko_USA_PlateCarrierH_CB"];
...
_pilotHelmet = ["RHS_jetpilot_usaf"];
_pilotRig = ["V_TacVest_oli"];
_pilotGlasses = [];

// Helicopter Pilot
_hPilotUniform = ["rhs_uniform_FROG01_wd"];
_hPilotHelmet = ["rhsusf_hgu56p"];
_hPilotRig = ["rhsusf_spc"];
_hPilotGlasses = [];
...
//	_loadout = f_param_backpacks;
	...
	{
		#include "f_assignGear_usmcw_b.sqf";
	};
};
