...
_scope2 = "rhsusf_acc_ACOG3";			// MRCO Scope - 1x - 6x
_scope4 = "rhsusf_acc_ELCAN";
_scope3 = "optic_SOS";			// SOS Scope - 18x - 75x

_bipod2 = "bipod_01_F_blk";		// Default bipod
...
// Automatic Rifleman
_AR = "RH_M27IAR";
_ARmag = "RH_60Rnd_556x45_M855A1";
_ARmag_tr = "RH_60Rnd_556x45_M855A1";
...
_baseUniform = ["U_B_SpecopsUniform_sgg"];
_baseHelmet = [];
_baseGlasses = ["rhs_balaclava"];

// Vests
_lightRig = ["V_PlateCarrier2_blk"];
...
//	_loadout = f_param_backpacks;
	...
	{
		#include "f_assignGear_seals_b.sqf";
	};
};
...
// LOADOUT: AUTOMATIC RIFLEMAN
	case "ar":
	{
		...
		_unit addweapon _pistol;
		["ar"] call _backpack;
		_attachments = [_attach2,_scope1,_bipod2];
