// F3 - Folk ARPS Assign Gear Script - Maverick
...
// Marksman rifle
_DMrifle = "hlc_rifle_awmagnum_FDE";
_DMriflemag = "hlc_5rnd_300WM_FMJ_AWM";
...
_baseUniform = ["U_PMC_BluTShirt_SJeans"];
_baseHelmet = ["rhsusf_mich_bare_norotos_arc_tan","H_MilCap_blue"];
_baseGlasses = [];
