// F3 - Folk ARPS Assign Gear Script - Coyote
...
_scope2 = "rhsusf_acc_ELCAN";			// MRCO Scope - 1x - 6x
...
// Default setup
_attachments = false; // The default attachment set for most units, overwritten in the individual unitType
...
// Backpacks
_bagsmall = "GerBag_sap";				// carries 120, weighs 20
_bagmedium = "B_TacticalPack_blk";				// carries 200, weighs 30
_baglarge =  "B_Carryall_rgr"; 	
...
// Woodland-Hex
_baseUniform = ["LOP_U_AFR_Fatigue_02"];
_baseHelmet = ["BWA3_CrewmanKSK_Tropen_Headset","MNP_MC_Rev","BWA3_CrewmanKSK_Tropen_Headset","MNP_MC_Rev","BWA3_CrewmanKSK_Tropen_Headset","MNP_MC_Rev","H_Cap_headphones","H_Bandanna_gry","H_Bandanna_cbr","H_Bandanna_khk","H_Bandanna_sgg"];
_baseGlasses = [];
...
_mediumRig = ["V_I_G_resistanceLeader_F","LOP_V_Chestrig_vsr"]; 	// default for all infantry classes
...
// Crewman
_crewUniform = ["LOP_U_AFR_Fatigue_02"];
...
// Spec Op
_sfuniform = ["LOP_U_AFR_Fatigue_02"];
_sfhelmet = ["BWA3_OpsCore_Schwarz_Camera"];
...
//	_loadout = f_param_backpacks;
	...
	{
		#include "f_assignGear_coyote_b.sqf";
	};
};
