...
_DMriflemag = "rhs_mag_9x18_12_57N181S";
...
// Woodland-Hex
_baseUniform = ["Niko_USA_MitchellFall"];
_baseHelmet = ["H_LIB_SOV_TankHelmet"];
...
_mediumRig = ["Rys_m2_def_mag"]; 	// default for all infantry classes
...
//	_loadout = f_param_backpacks;
	...
	{
		#include "f_assignGear_kgb_b.sqf";
	};
};
