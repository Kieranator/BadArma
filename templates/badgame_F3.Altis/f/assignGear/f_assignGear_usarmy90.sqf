...
// Vests
_lightRig = ["Niko_USA_PlateCarrierH_OD"];
_mediumRig = ["Niko_USA_PlateCarrierL_OD"]; 	// default for all infantry classes
_heavyRig = ["Niko_USA_PlateCarrierL_OD"];
...
//	_loadout = f_param_backpacks;
	...
	{
		#include "f_assignGear_usarmy90_b.sqf";
	};
};
